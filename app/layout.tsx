...
const options = {
  title: "Kajal Deore | Software Developer",
  description: "Kajal Deore is a Software Developer who is passionate about building solutions and contributing to open source communities",
