...
export const metadata: Metadata = {
  title: "Project | Kajal Deore",
  metadataBase: new URL("https://avdhesh-portfolio.vercel.app/projects"),
  description: "Explore projects built by Kajal Deore",
  openGraph: {
    title: "Projects | Kajal Deore",
